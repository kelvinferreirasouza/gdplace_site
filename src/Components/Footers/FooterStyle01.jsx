                ...
                <Container>
                    <Row>
                        ...
                        <Col lg={3} sm={6} className="xs:mb-[25px]">
                            <span className="mb-[20px] font-serif block font-medium text-themecolor xs:mb-[10px]">Endereço</span>
                            <p className="w-[85%] mb-[15px]">R Atanásio Bernardes, 831 Centro, Tijucas - SC</p>
                            <div><i className="feather-phone-call text-sm mr-[10px] text-themecolor"></i>(48) 99917-5093</div>
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={6} className="flex justify-center items-center text-center sm:mb-[20px]">
                            <p className="mb-0">
                                Copyright &copy; {new Date().getFullYear()} GDPlace - Todos os direitos reservados
                            </p>
                        </Col>
