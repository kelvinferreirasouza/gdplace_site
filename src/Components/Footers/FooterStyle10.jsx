...
const FooterStyle10 = (props) => {
    return (
        <Footer theme={props.theme} className={`bg-no-repeat bg-cover bg-[center_center]${props.className ? ` ${props.className}` : ""}`} style={{ backgroundImage: "url(/assets/img/webp/home-travel-agency-footer-bg.webp)" }}>
                ...
                <Row>
                    <Col sm={4} className="text-start xs:flex xs:justify-center xs:mb-[20px]">
                        <Link aria-label="link" to="/">
                            <img src="/assets/img/webp/logo_gdplace_branco.webp" alt="logo" width="111" height="36" />
                        </Link>
                    </Col>
