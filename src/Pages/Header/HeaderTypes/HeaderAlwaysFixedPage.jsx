    ...
    return (
        <>
            ...
            <Header topSpace={{ desktop: true }} type="always-fixed">
                <HeaderNav fluid="fluid" theme="white" bg="white" containerClass="sm:px-0" className="px-[35px] py-[0px] md:px-0 md:py-[20px]">
                    ...
                    <Col className="col-auto text-end pe-0 font-size-0 flex items-center !pl-0">
                        ...
                        <div className="pl-[17px] sm:hidden">
                            <Buttons ariaLabel="buy now" className="btn-fill font-medium font-serif uppercase rounded" themeColor="#0038e3" color="#fff" size="xs" title="buy now" />
                        </div>
                    </Col>
                </HeaderNav>
            </Header>
