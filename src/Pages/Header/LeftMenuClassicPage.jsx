            ...
            <Header topSpace={{ md: true }} type="pos-left" className="w-[290px] h-[100vh] z-10 md:w-full md:h-auto">
                    ...
                    <Col xs="auto" className="text-center leading-none">
                        <Link aria-label="header logo" to="/" className="inline-block leading-none">
                            <Navbar.Brand className="inline-block p-0 m-0">
                                <img className="default-logo" width="111" height="36" loading="lazy" src='https://via.placeholder.com/111x36' data-rjs='https://via.placeholder.com/222x72' alt='logo' />
                                <img className="alt-logo" width="111" height="36" loading="lazy" src='https://via.placeholder.com/111x36' data-rjs='https://via.placeholder.com/222x72' alt='logo' />
                                <img className="mobile-logo" width="111" height="36" loading="lazy" src='https://via.placeholder.com/111x36' data-rjs='https://via.placeholder.com/222x72' alt='logo' />
                            </Navbar.Brand>
                        </Link>
                    </Col>
                ...
                <HeaderNav className="hidden md:flex justify-between px-[30px] sm:px-[15px] md:py-[20px]" bg="white" theme="light" containerClass="px-0">
                    <Link className="flex items-center justify-center" to="/">
                        <Navbar.Brand className="inline-block p-0 m-0">
                            <img width="111" height="36" loading="lazy" src='https://via.placeholder.com/111x36' data-rjs='https://via.placeholder.com/222x72' alt='logo' />
                        </Navbar.Brand>
                    </Link>
                    <HamburgerMenu theme="dark" position="left" className="w-[290px] flex flex-col justify-end !top-[var(--header-height)]" closeBtn={false}>
